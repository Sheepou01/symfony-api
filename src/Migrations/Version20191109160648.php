 ...
 */
final class Version20191109160648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wiki ADD author_id INT DEFAULT NULL, ADD online TINYINT(1) DEFAULT \'1\' NOT NULL, ADD source VARCHAR(255) DEFAULT NULL, ADD image VARCHAR(255) DEFAULT NULL');
