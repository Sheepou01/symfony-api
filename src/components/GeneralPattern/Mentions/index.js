...
const Mentions = () => (
  <div id="mentions-view">
    ...
    <p className="mentions">
      ...
      L’utilisation du site www.5MAP.fr implique l’acceptation pleine et
      ...
      les utilisateurs du site www.5MAP.fr sont donc invités à les consulter de manière régulière.
      Ce site est normalement accessible à tout moment aux utilisateurs.
      Une interruption pour raison de maintenance technique
      peut être toutefois décidée par www.5MAP.fr, qui s’efforcera alors
      de communiquer préalablement aux utilisateurs
      les dates et heures de l’intervention.
      Le site www.5MAP.fr est mis à jour régulièrement par l’agence 5MAP.
    ...
    <p>
      ...
      aussi précises que possible. Toutefois, il ne pourra être tenue responsable
      ...
      Toutes les informations indiquées sur le site www.5MAP.fr sont données à titre
       indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements
      figurant sur le site www.5MAP.fr ne sont pas exhaustifs. Ils sont donnés sous
    ...
    et n'utilisera en aucun cas son contenu à des fins lucratives et autres que pédagogique </p>
      ...
      sont à la disposition des utilisateurs. 5MAP se réserve le droit de supprimer,
      ...
      dispositions relatives à la protection des données. Le cas échéant, 5MAP se
      ...
      octobre 1995.
      A l’occasion de l’utilisation du site www.5MAP.fr, peuvent êtres
      recueillies : l’URL des liens par l’intermédiaire desquels
      l’utilisateur a accédé au site www.5MAP.fr, le fournisseur d’accès
      de l’utilisateur, l’adresse de protocole Internet (IP) de l’utilisateur.
      En tout état de cause l’agence web 5MAP ne collecte des informations
      personnelles relatives à l’utilisateur que pour le besoin de certains
      services proposés par le site www.5MAP.fr. L’utilisateur fournit ces
      informations en toute connaissance de cause, notamment lorsqu’il procède
      par lui-même à leur saisie. Il est alors précisé à l’utilisateur du
      site www.5MAP.fr l’obligation ou non de fournir ces informations.
      ...
      Aucune information personnelle de l’utilisateur du site www.5MAP.fr n’est
      ...
      5MAP et de ses droits permettrait la transmission des dites informations

      à l’éventuel acquéreur qui serait à son tour tenu de la même obligation
      de conservation et de modification des données vis à vis de l’utilisateur
      du site www.5MAP.fr.
